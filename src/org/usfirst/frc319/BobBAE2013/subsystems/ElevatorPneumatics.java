 ...
 *
 */
public class ElevatorPneumatics extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    DoubleSolenoid arm = RobotMap.elevatorPneumaticsArm;
    Solenoid wheel = RobotMap.elevatorPneumaticsWheel;
    DoubleSolenoid lock = RobotMap.elevatorPneumaticsLock;
